...
func (_m *MockTx) Ping(ctx context.Context) error {
	ret := _m.Called(ctx)
...
// MockTx_Ping_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Ping'
type MockTx_Ping_Call struct {
	*mock.Call
}

// Ping is a helper method to define mock.On call
//   - ctx context.Context
func (_e *MockTx_Expecter) Ping(ctx interface{}) *MockTx_Ping_Call {
	return &MockTx_Ping_Call{Call: _e.mock.On("Ping", ctx)}
}

func (_c *MockTx_Ping_Call) Run(run func(ctx context.Context)) *MockTx_Ping_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context))
	})
	return _c
...
func (_c *MockTx_Ping_Call) Return(_a0 error) *MockTx_Ping_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockTx_Ping_Call) RunAndReturn(run func(context.Context) error) *MockTx_Ping_Call {
	_c.Call.Return(run)
	return _c
}
